...
abstract class CmsAttributeStructure<T extends Object> extends Equatable {
  /// This id will be used to identify a specific CmsAttribute of an CmsObject. The id has to be unique per CmsObject.
  final String id;
  ...
  CmsAttributeValue toEmptyAttributeValue() {
    return CmsAttributeValue<T>(
      id: id,
      value: defaultValue,
    );
  }
