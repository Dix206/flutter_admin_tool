...
class CmsAttributeFileWidget extends StatefulWidget {
  final CmsFileValue? currentValue;
  final CmsAttributeFile cmsTypeFile;
  final bool shouldDisplayValidationErrors;
  final OnCmsTypeUpdated<CmsFileValue> onCmsTypeUpdated;

  const CmsAttributeFileWidget({
    Key? key,
  ...
  @override
  State<CmsAttributeFileWidget> createState() => _CmsAttributeFileWidgetState();
}

class _CmsAttributeFileWidgetState extends State<CmsAttributeFileWidget> {
  @override
          ...
          title: Text(
            widget.currentValue?.fileName ??
                (widget.currentValue?.wasDeleted != true && widget.currentValue?.url != null
                    ...
                    : FlutterCms.getCmsTexts(context).cmsAttributeFileSelectFileMessage),
          ),
