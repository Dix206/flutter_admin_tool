...
import 'package:firebase_example/event/use_cases/create_event.dart';
import 'package:firebase_example/event/use_cases/delete_event.dart';
import 'package:firebase_example/event/use_cases/load_event_by_id.dart';
import 'package:firebase_example/event/use_cases/load_events.dart';
import 'package:firebase_example/event/use_cases/update_event.dart';
...
final eventFlatObject = FlatObjectStructure(
  ...
  onLoadFlatObjects: LoadFlatObjects.curser(loadEvents),
